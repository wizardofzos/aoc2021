...
api.add_resource(PYTHOND12, '/d12-python')
docs.register(PYTHOND12)
api.add_resource(REXXD15P1, '/d15p01-rexx')
docs.register(REXXD15P1)
api.add_resource(REXXD15P2, '/d15p02-rexx')
docs.register(REXXD15P2)
api.add_resource(PYTHOND15, '/d15-python')
docs.register(PYTHOND15)
api.add_resource(REXXD16P1, '/d16p01-rexx')
docs.register(REXXD16P1)
api.add_resource(REXXD16P2, '/d16p02-rexx')
docs.register(REXXD16P2)
